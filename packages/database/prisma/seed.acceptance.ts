...
function createSchema(db: { run(sql: string): void }) {
  db.run(`
    ...
    CREATE TABLE TrialRun (id TEXT PRIMARY KEY, periodId TEXT NOT NULL, departmentId TEXT NOT NULL, name TEXT NOT NULL, status TEXT NOT NULL, startedBy TEXT NOT NULL, startedAt TEXT NOT NULL, completedBy TEXT, completedAt TEXT, result TEXT, summary TEXT, createdAt TEXT NOT NULL, updatedAt TEXT NOT NULL);
    CREATE TABLE TrialRunIssue (id TEXT PRIMARY KEY, trialRunId TEXT NOT NULL, severity TEXT NOT NULL, category TEXT NOT NULL, title TEXT NOT NULL, description TEXT NOT NULL, ownerRole TEXT NOT NULL, status TEXT NOT NULL, createdBy TEXT NOT NULL, createdAt TEXT NOT NULL, resolvedBy TEXT, resolvedAt TEXT, resolution TEXT);
    CREATE TABLE TrialRunReport (id TEXT PRIMARY KEY, trialRunId TEXT NOT NULL, periodId TEXT NOT NULL, departmentId TEXT NOT NULL, gitCommit TEXT NOT NULL, dataSourceSummary TEXT NOT NULL, importBatchSummary TEXT, trialRunRunNos TEXT NOT NULL, approvalRunNo TEXT NOT NULL, targetAmountCents INTEGER NOT NULL, confirmedRevenueAmountCents INTEGER NOT NULL, achievementRateBps INTEGER NOT NULL, commissionPoolCents INTEGER NOT NULL, currentPayoutTotalCents INTEGER NOT NULL, futurePayoutTotalCents INTEGER NOT NULL, adjustmentTotalCents INTEGER NOT NULL, frozenTotalCents INTEGER NOT NULL, issueSummary TEXT NOT NULL, residualRiskSummary TEXT, result TEXT NOT NULL, acceptedBy TEXT NOT NULL, acceptedAt TEXT NOT NULL, markdown TEXT NOT NULL, createdAt TEXT NOT NULL);
    CREATE TABLE CommissionAdjustment (id TEXT PRIMARY KEY, periodId TEXT NOT NULL, settlementRunId TEXT, userId TEXT NOT NULL, departmentId TEXT NOT NULL, adjustmentType TEXT NOT NULL, amountCents INTEGER NOT NULL, direction TEXT NOT NULL, reason TEXT NOT NULL, evidenceUrl TEXT, status TEXT NOT NULL, requestedBy TEXT NOT NULL, requestedAt TEXT NOT NULL, approvedBy TEXT, approvedAt TEXT, appliedRunId TEXT, createdAt TEXT NOT NULL, updatedAt TEXT NOT NULL);
    CREATE TABLE PeriodReopenRequest (id TEXT PRIMARY KEY, periodId TEXT NOT NULL, requestedBy TEXT NOT NULL, requestedAt TEXT NOT NULL, reason TEXT NOT NULL, status TEXT NOT NULL, approvedBy TEXT, approvedAt TEXT, createdAt TEXT NOT NULL, updatedAt TEXT NOT NULL);
    CREATE TABLE CommissionOperationLog (id TEXT PRIMARY KEY, operatorId TEXT NOT NULL, operatorRole TEXT NOT NULL, action TEXT NOT NULL, resourceType TEXT NOT NULL, resourceId TEXT, beforeJson TEXT, afterJson TEXT, createdAt TEXT NOT NULL);
  `);
}
